...
For Canadians, the order of operations is straightforward: max out your TFSA first, then your RRSP, then a non-registered account. Fill each one with VEQT and go live your life. The [If You Invested calculator](/calculators) can show you what this looks like with real historical data.
