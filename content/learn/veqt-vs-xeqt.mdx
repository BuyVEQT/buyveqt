...
One concrete consequence: BlackRock CEO Larry Fink earned $37.7 million in compensation in 2025, up from $30.8 million the year before. We know this because BlackRock files it with the SEC — outside shareholders are entitled to that disclosure. Vanguard's CEO compensation is not publicly disclosed, because Vanguard has no outside shareholders to disclose to. The asymmetry is the argument.
...
The most recent example played out on the very products this article compares. In November 2025, Vanguard cut VEQT's management fee from 0.22% to 0.17%. About a month later, BlackRock cut XEQT's fee from 0.18% to the same 0.17%. The pattern is decades old: Vanguard moves first, the industry follows.

Vanguard has cut fees more than 2,100 times since its founding. The February 2025 cut alone — covering 168 share classes — delivered $350 million in annual savings to investors. You can read more in our breakdown of [what VEQT's MER actually costs you](/learn/veqt-mer-true-cost). None of that competition exists without Vanguard pushing the envelope.
