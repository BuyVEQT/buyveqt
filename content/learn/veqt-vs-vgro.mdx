...
<TableOfContents items="Same Provider, Different Risk | What Do the Bonds Actually Do | The Numbers in a Bad Year | When VEQT Makes More Sense | When VGRO Makes More Sense | The Psychological Angle | Historical Context | You Can Always Switch | The Bottom Line" />
...
For up-to-date performance data, check the [VEQT vs VGRO comparison page](/compare/veqt-vs-vgro). Curious about Avantis's factor-tilted alternative to the index trio? See [VEQT vs CAGE](/compare/veqt-vs-cage).
