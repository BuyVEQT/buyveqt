...
VEQT holds approximately 13,700 stocks across the entire world. When VEQT drops, it means global stock markets are dropping. Your fund isn't broken. The world economy is repricing.
...
Want to see the data? Use our [If You Invested calculator](/calculators) to check what happened if you invested right before the COVID crash in February 2020. The result might surprise you.
...
**1. It locks in a paper loss as a real loss.** Right now, your loss is only on paper. Your portfolio is down in value, but you still own the same number of VEQT shares, representing the same ownership in ~13,700 companies. Selling converts that temporary paper loss into a permanent actual loss.
...
**Need perspective?** Check the [home page](/) for current performance, use the [If You Invested calculator](/calculators) to see how past drops recovered, or visit [r/JustBuyVEQT](https://www.reddit.com/r/JustBuyVEQT/) where others are going through the same thing.
