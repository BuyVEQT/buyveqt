...
category: "opinion"
difficulty: "beginner"
tags: ["dca", "lump-sum", "asset-allocation", "market-timing", "psychology"]
...
Want to see how regular contributions would have grown? Try the [If You Invested calculator](/calculators) to model DCA scenarios with real historical prices.

<Callout type="tip">
Want to see how DCA would have performed with VEQT? [Try our DCA calculator](/calculators) to model different contribution amounts and start dates with real historical prices.
</Callout>
