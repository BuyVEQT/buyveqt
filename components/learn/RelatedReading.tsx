      ...
      <ul>
        {related.map((article) => (
          <li key={article.slug}>
            ...
            >
              <h3
                className="bs-display text-[1.0625rem] sm:text-[1.125rem] leading-[1.2] group-hover:underline group-hover:decoration-2 group-hover:underline-offset-4 transition-[text-decoration]"
                style={{ color: "var(--ink)" }}
              >
                {article.title}
              </h3>
