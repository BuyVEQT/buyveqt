    ...
    <div className="mt-10 border-t-2 border-[var(--ink)] pt-6">
      {next && (
        ...
        >
          ...
          <h3 className="bs-display text-[1.75rem] sm:text-[2.25rem] leading-[1.05] group-hover:underline group-hover:decoration-2 group-hover:underline-offset-4 transition-[text-decoration]">
            {next.title}
          </h3>
          <p
