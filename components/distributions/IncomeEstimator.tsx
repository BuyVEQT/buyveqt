    ...
    <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-card)] p-5">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full sm:w-48 rounded-lg border border-[var(--color-border)] bg-[var(--color-card)] px-3 py-2.5 font-medium tabular-nums focus:outline-none focus:ring-2 focus:ring-[var(--color-brand)]/30 focus:border-[var(--color-brand)]"
